...
const (
	Metrics_UpdatesMetrics_FullMethodName = "/metriq.Metrics/UpdatesMetrics"
	Metrics_UpdateMetric_FullMethodName   = "/metriq.Metrics/UpdateMetric"
	Metrics_GetMetric_FullMethodName      = "/metriq.Metrics/GetMetric"
	Metrics_GetMetrics_FullMethodName     = "/metriq.Metrics/GetMetrics"
)
...
type MetricsClient interface {
	UpdatesMetrics(ctx context.Context, in *UpdateMetricsRequest, opts ...grpc.CallOption) (*UpdateMetricsResponse, error)
...
func (c *metricsClient) UpdatesMetrics(ctx context.Context, in *UpdateMetricsRequest, opts ...grpc.CallOption) (*UpdateMetricsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateMetricsResponse)
	err := c.cc.Invoke(ctx, Metrics_UpdatesMetrics_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MetricsServer interface {
	UpdatesMetrics(context.Context, *UpdateMetricsRequest) (*UpdateMetricsResponse, error)
...
func (UnimplementedMetricsServer) UpdatesMetrics(context.Context, *UpdateMetricsRequest) (*UpdateMetricsResponse, error) {
...
func _Metrics_UpdatesMetrics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MetricsServer).UpdatesMetrics(ctx, req.(*UpdateMetricsRequest))
	}
