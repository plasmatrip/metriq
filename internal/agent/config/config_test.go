...
func TestConfig_Agent_NewConfig_env(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			want: Config{
				Host:               "server.com:8585",
				PollInterval:       2,
				ReportInterval:     10,
				RateLimit:          5,
				ClientTimeout:      5000000000,
				StartRetryInterval: 1000000000,
				RetryInterval:      2000000000,
				MaxRetries:         3,
				CryptoKeyPath:      "",
				CryptoKey:          nil,
			},
	...
	tests := []struct {
	...
	}{
		{
			...
			want: Config{
				...
				PollInterval:   2,
				ReportInterval: 10,
				RateLimit:      5, ClientTimeout: 5000000000,
				StartRetryInterval: 1000000000,
				RetryInterval:      2000000000,
				MaxRetries:         3,
				CryptoKeyPath:      "",
		...
		},
		{
			...
			want: Config{
				Host:         "server.com:8585",
				PollInterval: 2, ReportInterval: 10,
				RateLimit: 5, ClientTimeout: 5000000000,
				StartRetryInterval: 1000000000,
				RetryInterval:      2000000000,
				MaxRetries:         3,
